...
FROM node:22.17.0-alpine AS new-frontend-build
...
FROM ghcr.io/usa-reddragon/mesh-base:main@sha256:facc1cce9ccaabf2cd97859b436bad60094bfcae5be9800f3881281351452caa
